...
for split in splits:
    if split == 'train':
        ...
        valid_clips = range(44,45)

    video_folder = "/home/mrpk9/UAV_Dataset_Togather/U2UD&T/Videos/test"
    anno_files = glob.glob('/home/mrpk9/UAV_Dataset_Togather/U2UD&T/NPS-Drones-Dataset/*') #Clip_001.txt
    frame_directory = '/home/mrpk9/UAV_Dataset_Togather/U2UD&T/AllFrames/' #Clip_1_000000.png
    output_image_folder = '/home/mrpk9/UAV_Dataset_Togather/U2UD&T/nps_sample/' + split + '/images'
    output_annos_folder = '/home/mrpk9/UAV_Dataset_Togather/U2UD&T/nps_sample/' + split + '/annotations'
    output_videos_folder = '/home/mrpk9/UAV_Dataset_Togather/U2UD&T/nps_sample/' + split + '/videos'
